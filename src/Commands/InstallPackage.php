...
class InstallPackage extends Command
{
     ...
     * @var string
     */
    protected $signature = 'trustup_pro_admin_common:install';
     ...
     * @var string
     */
    protected $description = 'Installing trustup_pro_admin_common package.';
    ...
    {
        return File::exists(config_path(Package::prefix() . '.php'));
    }
    ...
    {
        $params = [
            '--provider' => TrustupProAdminCommonServiceProvider::class,
            '--tag' => "config"
        ];
